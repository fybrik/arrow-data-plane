use crate::types::{Pointer, WasmModule};
...
#[no_mangle]
pub fn wasm_instance(path: String) -> i64 {
    ...
    let alloc = instance
        .exports
        .get_native_function::<i64, i32>("alloc")
        .unwrap();
    let dealloc = instance
        .exports
        .get_native_function::<(i64, i64), ()>("dealloc")
        .unwrap();
...
// A function to release the WasmModule object that was allocated in `wasm_instance`.
#[no_mangle]
pub fn wasm_drop(wasm_module_ptr: i64) {
...
#[no_mangle]
pub fn wasm_alloc(wasm_module_ptr: i64, size: i64) -> i64 {
...
#[no_mangle]
pub fn wasm_mem_ptr(wasm_module_ptr: i64) -> i64 {
    let wasm_module = Into::<Pointer<WasmModule>>::into(wasm_module_ptr).borrow();
...
#[no_mangle]
pub fn wasm_dealloc(wasm_module_ptr: i64, offset: i64, size: i64) {
    let wasm_module = Into::<Pointer<WasmModule>>::into(wasm_module_ptr).borrow();
