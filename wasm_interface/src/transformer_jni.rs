...
#[no_mangle]
pub extern "system" fn Java_org_m4d_adp_transform_TransformInterface_TransformationIPC(_env: JNIEnv,_class: JClass, wasm_module_ptr: jptr, address: jlong, length: jlong) -> jptr {
    ...
    let transformed_tuple = read_transform_write_from_bytes_wasm.call(address as i64, length as i64).unwrap();
    transformed_tuple
}
